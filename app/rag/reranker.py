"""Explainable deterministic reranking for RAG candidates."""
...
def rerank_candidates(candidates: list[RetrievalCandidate], analysis: QueryAnalysis) -> list[RetrievalCandidate]:
    """Rank merged candidates with visible feature contributions.

    This is intentionally deterministic for the first version. A cross-encoder
    reranker can later replace this function while preserving `final_score` and
    `rerank_reasons` for observability.
    """
